...
import fr.miageamiens.isi05.sudoku.modele.GrilleImpl;
...
public class GrilleFactoryImpl implements GrilleFactory {
   ...
   */
  public Grille create(Collection<ValeurDeCase> valeurDeCasesAutorisees,
      ValeurDeCase[][] valeurDeCasesInitiales) {
    Grille grille = new GrilleImpl();
    ((GrilleImpl) grille).initialisation(valeurDeCasesAutorisees, valeurDeCasesInitiales);
    return grille;
  }
